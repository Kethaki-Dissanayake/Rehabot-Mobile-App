            ...
            <ScrollView>
                ...
                <View>
                    <TouchableOpacity onPress={()=>{navigation.navigate("Forget")} }>
                        <Text style={{textAlign:'center',color:'#a84432', fontSize:16 }}> Forgot Password?</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View>
                <Text style={{textAlign:'center',color:'#3250a8', fontSize:16 }}> If you don't have an account?</Text>
                    <TouchableOpacity onPress={()=>{navigation.navigate("Register")}}>
                        <Text style={{textAlign:'center',color:'#3250a8', fontSize:18, fontWeight:'bold' }}> Register</Text>
                    </TouchableOpacity>
                </View>
